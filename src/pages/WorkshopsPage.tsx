              ...
              <main className="flex-1">
                  ...
                  {selectedCategory === 'Todas' && selectedLevel === 'Todos los Niveles' && selectedInstructor === 'Todos' && !searchTerm && (
                      <div className="relative rounded-3xl overflow-hidden mb-10 shadow-lg group">
                          {/* Slide Content */}
                          <div 
                            className="relative h-[300px] md:h-[350px] cursor-pointer"
                          ...
                          >
                              ...
                              <div className="relative z-10 p-8 md:p-12 flex flex-col justify-center h-full md:w-2/3">
                                  ...
                                  <h2 className="text-3xl md:text-4xl font-display font-bold text-white mb-4 leading-tight line-clamp-2 animate-in slide-in-from-bottom-2 duration-500 delay-100">
