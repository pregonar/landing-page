      ...
      <nav className="bg-white border-b border-gray-200 sticky top-0 z-40 px-6 h-16 flex items-center justify-between shadow-sm">
          ...
          <div className="flex items-center gap-3">
              ...
              {step < 5 ? (
                  ...
                  <button 
                    onClick={() => { alert('Event Published!'); onNavigate('events'); }}
                    className="bg-brand-red text-white px-6 py-2 rounded-lg font-bold text-sm hover:bg-red-600 shadow-lg shadow-brand-red/20 transition-all"
                  >
                      Publish Event
                  </button>
              )}
              ...
              {step === 5 && (
                  <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                      ...
                      <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-200">
                          ...
                          <button 
                            onClick={() => { alert('Event Published!'); onNavigate('events'); }}
                            className="w-full bg-brand-red hover:bg-red-600 text-white font-bold py-4 rounded-xl shadow-lg shadow-brand-red/25 transition-all active:scale-95 text-lg"
                          >
                              Publish Event <ArrowRight size={20} className="inline ml-2" />
                          </button>
